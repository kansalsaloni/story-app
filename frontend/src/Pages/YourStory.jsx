...
function YourStory({ isShimmerLoading }) { 
  ...
  return (
    <>
          ...
          <div className='category-cards'>
            {isShimmerLoading ? (
              ...
              displayedStories.map((story) => (
                <div className='your-story-edit-cards' key={story.id}>
                  <div
      ...
      {isCreateStoryPopupOpen && <CreateStoryPopUp />}
      {isModalOpen && <StorySlide story={selectedStory} onClose={() => setIsModalOpen(false)} />}
    </>
  );
}
